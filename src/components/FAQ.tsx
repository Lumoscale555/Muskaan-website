...
const faqs = [
  ...
  },
  {
    ...
    answer: "We maintain transparent communication through your preferred channels, email, phone, or in person meetings. You will receive regular updates on case progress, upcoming deadlines, and strategic decisions. We are committed to keeping you informed and involved throughout the legal process."
  },
  {
    question: "Do you handle emergency legal situations?",
    answer: "Yes, we understand that legal emergencies require immediate attention. For urgent matters such as arrests, injunctions, or time sensitive legal issues, we offer expedited consultation services. Contact our office immediately and we will prioritize your case accordingly."
  }
];
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            {faqs.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="bg-white rounded-2xl px-8 border border-border/50 shadow-sm hover:shadow-md transition-all duration-300"
              >
